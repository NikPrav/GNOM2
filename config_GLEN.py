...
configuration = {
    'experiments':  {
        'names': ['AF', 'BB', 'KL', 'NE', 'OT', 'QF', 'SH', 'WE'],
        'files': {
            'AF': {
                'train_files': ['AF13_train'],
                'val_files':   ['AF13_val'],
                'test_files':  ['AF13_test']
            },
            'BB': {
                'train_files': ['BB13_train'],
                'val_files':   ['BB13_val'],
                'test_files':  ['BB13_test']
            },
            'KL': {
                'train_files': ['Kaggle_train'],
                'val_files':   ['Kaggle_val'],
                'test_files':  ['Kaggle_test']
            },
            'NE': {
                'train_files': ['NEQ15_train'],
                'val_files':   ['NEQ15_val'],
                'test_files':  ['NEQ15_test']
            },
            'OT': {
                'train_files': ['OT13_train'],
                'val_files':   ['OT13_val'],
                'test_files':  ['OT13_test']
            },
            'QF': {
                'train_files': ['QF13_train'],
                'val_files':   ['QF13_val'],
                'test_files':  ['QF13_test']
            },
            'SH': {
                'train_files': ['SH12_train'],
                'val_files':   ['SH12_val'],
                'test_files':  ['SH12_test']
            },
            'WE': {
                'train_files': ['WTE12_train'],
                'val_files':   ['WTE12_val'],
                'test_files':  ['WTE12_test']
            },
        }
    },
    "data":         {
...
class Config(object):
    ...
    def print_config(self, indent=4, sort=False):
        """ Prints the config. """
