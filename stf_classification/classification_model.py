...
from .transformer_models.albert_model import (
    AlbertForSequenceClassification,
)
from .transformer_models.bert_model import (
    BertForSequenceClassification,
)
from .transformer_models.camembert_model import (
    CamembertForSequenceClassification,
)
from .transformer_models.distilbert_model import (
    DistilBertForSequenceClassification,
)
from .transformer_models.flaubert_model import (
    FlaubertForSequenceClassification,
)
from .transformer_models.layoutlm_model import (
    LayoutLMForSequenceClassification,
)
from .transformer_models.longformer_model import (
    LongformerForSequenceClassification,
)
from .transformer_models.mobilebert_model import (
    MobileBertForSequenceClassification,
)
from .transformer_models.roberta_model import (
    RobertaForSequenceClassification,
)
from .transformer_models.xlm_model import (
    XLMForSequenceClassification,
)
# from .transformer_models.xlm_roberta_model import (
#     XLMRobertaForSequenceClassification,
# )
from .transformer_models.xlnet_model import (
        ...
        if use_cuda:
            if torch.cuda.is_available():
                if cuda_device == -1:
                    ...
                    self.device = torch.device(f"{cuda_device}")
            else:
                raise ValueError(
        ...
        **kwargs,
        ...
        for i, batch in enumerate(
            ...
            with torch.no_grad():
                ...
                if multi_label or inputs["labels"].shape[-1] == 1:
            ...
            if inputs["labels"].shape[-1] > 1 and len(inputs["labels"].shape) > 1 and not multi_label:
                out_label_ids[start_index:end_index] = (
                    torch.argmax(inputs["labels"].detach(), dim=-1).cpu().numpy()
                )
            else:
                out_label_ids[start_index:end_index] = (
